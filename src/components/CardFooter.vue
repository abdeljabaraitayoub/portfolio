<template>
  <div>
    ...
    >
      ...
      <a
        href="https://www.fiverr.com/r_sailesh"
        target="_blank"
    ...
    <div class="text-center">
      <a
        href="https://www.linkedin.com/in/saileshrijal"
        target="_blank"
        class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"
        ><font-awesome-icon icon="fa-brands fa-linkedin"
      /></a>
      <a
        href="https://www.facebook.com/saileshrijalprofile"
        target="_blank"
        class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"
        ><font-awesome-icon icon="fa-brands fa-facebook"
      /></a>
      <a
        href="https://www.instagram.com/sailesh_rijal/"
        target="_blank"
        class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"
        ><font-awesome-icon icon="fa-brands fa-instagram"
      /></a>
      <a
        href="https://github.com/saileshrijal"
        target="_blank"
        class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"
      >
      ...
      /></a>
      <a
        href="mailto:saileshrijal0011@gmail.com"
        class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"
      >
